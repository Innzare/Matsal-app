...
export default function Favourites() {
  ...
  return (
    <View style={{ paddingTop: insets.top }} className="flex-1 bg-white dark:bg-dark-surface">
      ...
      <Tabs.Container
        headerContainerStyle={{ shadowColor: 'transparent', backgroundColor: isDark ? '#222233' : '#fff' }}
        renderTabBar={(props) => <TopTabs {...props} />}
        initialTabName="Еда"
      >
        <Tabs.Tab name="Еда" label="Еда">
          <Tabs.ScrollView className="bg-stone-100 dark:bg-dark-bg">
            {favoriteItems.length > 0 ? (
              ...
              <View className="items-center justify-center flex-1 pb-[150px]">
                <View className="items-center">
                  <View className="w-[130px] h-[130px] justify-center items-center mb-6 rounded-xl border border-stone-200 dark:border-dark-border bg-white dark:bg-dark-surface mt-10">
                  ...
                  <Text className="text-stone-500 dark:text-dark-muted text-center mt-4 px-10 leading-5">
            ...
            {favoriteGroceryItems.length > 0 ? (
              ...
              <View className="items-center justify-center flex-1 pb-[150px]">
                <View className="items-center">
                  ...
                  <Text className="text-stone-500 dark:text-dark-muted text-center mt-4 px-10 leading-5 items-center">
